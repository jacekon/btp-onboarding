...
<!-- description -->Once the Kyma module "Serverless" is added and ready in your Kyma environment, it's time to create your first function and microservice in Kyma.

In this tutorial, you will use Kyma dashboard to create a Kyma Function and a microservice.
